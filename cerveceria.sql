...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-11-2022 a las 04:21:08
...
(2, 1, 'Scotch', 'Escocia es tierra de cebada y la Scotch Ale lleva ese paisaje impregnado en su codigo genetico. Rubi intenso. Seis grados de alcohol. Dulce y maltosa.', 425),
...
(4, 1, 'Honey Beer', 'Babilonia antigua. Tras la boda, el padre de la novia convida al futuro yerno con cerveza de miel a lo largo de un mes. Asi lo dicta la tradicion.', 400),
(6, 2, 'Caravana', 'Llega la primavera. Cambiamos la ropa, hacemos mas deporte. El lupulo empieza a brotar apasionado.', 600),
(12, 2, 'Cream Stout', 'El paladar de nuestros comensales ha evolucionado con el tiempo, como nuestras cervezas. Esta es una seleccion de nuestras cervezas mas nuevas.', 450),
(16, 1, 'Porter', 'Las cervezas que nos han acompañado desde un principio, gracias a las cuales somos quiénes somos hoy.', 500),
(17, 2, 'ANASHE', 'nashe', 300),
(18, 1, 'ANASHE', 'nashe', 300),
(19, 1, 'Nuevo', 'nashe', 300),
(20, 1, 'Nuevo', 'nashe', 300),
(21, 1, 'nombre actualizadooooo', 'nashe actualizado', 350);
...
(13, 'actualizada jeee', 'Las cervezas que nos han acompañado desde un principio, gracias a las cuales somos quiénes somos hoy.'),
(15, 'ultima nueva', 'algo');
...
--
ALTER TABLE `cerveza`
  MODIFY `id_cerveza` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
